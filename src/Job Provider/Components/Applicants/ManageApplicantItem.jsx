...
const ApplicantItem = ({ setAction, ...props }) => {
  ...
  const shortlistCandidateHandler = () => {
    axios
      .patch(
        `${
          `${API_URL}/provider/applicants/shortlist/` + applicantItemId
        }`,
        {},
        {
          headers: {
  ...
  const rejectCandidateHandler = () => {
    axios
      .patch(
        `${
          `${API_URL}/provider/applicants/reject/` + applicantItemId
        }`,
        {},
        {
          headers: {
  ...
  const viewResumeHandler = () => {
    axios
      .get(
        `${
          `${API_URL}/provider/applicants/view-resume/` + applicantItemId
        }`,
        {
          headers: {
            Authorization: "Bearer " + token,
